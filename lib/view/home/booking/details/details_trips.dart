...
class DetailsBookingTrips extends StatelessWidget {
  PageController detailsBookingTrips = PageController();
  DetailsBookingTrips({super.key,required this.detailsBookingTrips});
            ...
            Padding(
              ...
              child: Row(
                children: [
                  GestureDetector(
                    onTap:(){
                      detailsBookingTrips.animateToPage(0, duration: Duration(microseconds: 30), curve: Curves.easeIn);
                    },
                    child: CustomText(
                        text: "Booking",
                        size: 12.sp,
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Spacer(),
                                          CustomText(text: "Trips", size: 16.sp, color: darkGrey, fontWeight: FontWeight.w500,alignment: Alignment.centerRight,),
                                      ...
                                      Row(
                                        children: [
                                          CustomText(text: "Trip Type", size: 16.sp, color: black, fontWeight: FontWeight.w600,alignment: Alignment.centerLeft,),
                                          Spacer(),
                                          CustomText(text: "Cairo Trip", size: 16.sp, color: darkGrey, fontWeight: FontWeight.w500,alignment: Alignment.centerRight,),
