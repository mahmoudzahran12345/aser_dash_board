...
class OrdersTrips extends StatelessWidget {
  PageController order = PageController();
   OrdersTrips({super.key,required this.order});
                              ...
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: DropdownButton(
                                      ...
                                      underline: SizedBox(),
                                      value: TripsCubit.get(context).accomandtionType,
