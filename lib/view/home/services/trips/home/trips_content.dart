                              ...
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: DropdownButton(
                                      ...
                                      borderRadius: BorderRadius.circular(10.r),
                                      underline: SizedBox(),
                                      value: TripsCubit.get(context).goverment,
                              ...
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: DropdownButton(
                                      ...
                                      hint: CustomText(text: "Trip Status", size: 12.sp, color: black, fontWeight: FontWeight.w600),
                                      items: ["panding", "active", "complete"]
                                          .map((e) => DropdownMenuItem(
                                        value: e,
                                        child: Padding(
                                          padding: EdgeInsets.only(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: HotelDateTableTriple(triple: tripleContent,),
                        ),
                        SizedBox(height: 20.h),
                        Row(
