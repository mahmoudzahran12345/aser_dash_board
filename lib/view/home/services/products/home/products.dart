                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: DropdownButton(
                                  ...
                                  underline: SizedBox(),
                                  value: ProductCubit.get(context).choseHours,
                                  ...
                                  onChanged: (val){
                                    ProductCubit.get(context).choseHoursFunction(val);
                                  }),
                            ),
                          ),
                        ],
                              ...
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: DropdownButton(
                                      ...
                                      borderRadius: BorderRadius.circular(10.r),
                                      underline: SizedBox(),
                                      value: ProductCubit.get(context).goverment,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(width: 30.w,),
                            CustomText(text: "( 30 Products)", size: 16.sp, color: darkGrey, fontWeight: FontWeight.w500),
                            Spacer(),
                            GestureDetector(
                              onTap: (){
                        ...
                        Container(
                          ...
                          child: ProductTable(triple: product,),
                        ),
                        SizedBox(height: 20.h),
                        Row(
