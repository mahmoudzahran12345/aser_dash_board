            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      controller.animateToPage(3, duration: Duration(milliseconds: 60), curve: Curves.easeIn);
                    },
                    child: Container(
                      width: 167.w,
                      height: 50.h,
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Row(
                      children: [
                        CustomText(text: "Advertisements", size: 20.sp, color: black, fontWeight: FontWeight.w600),
                        SizedBox(width: 30.w,),
                        CustomText(text: "( 30 Advertisement)", size: 16.sp, color: darkGrey, fontWeight: FontWeight.w500),
                        Spacer(),
                        GestureDetector(
                          onTap: (){
