                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Spacer(),
                                        CustomText(
                                          text: HomeCubit.get(context).systemProfit!.data!.total.toString(),
                                          size: 20.sp,
                                          color: blue,
                                          fontWeight: FontWeight.w600,
                                        ),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: DropdownButton(
                                              ...
                                              underline: SizedBox(),
                                              value: HomeCubit.get(context).choosesMonth,
                                              hint: CustomText(text: "Month", size: 12.sp, color: darkGrey, fontWeight: FontWeight.w600),
                                              items: HomeCubit.get(context).month.map((e) =>
                                                  DropdownMenuItem(
                                                    value: e,
                                                    child: Padding(
                                              ...
                                              onChanged: (val) {
                                                if(val == "January"){
                                                  HomeCubit.get(context).fix = "1";
                                                }
                                                else if (val == "February"){
                                                  HomeCubit.get(context).fix = "2";
                                                }
                                                else if(val == "March"){
                                                  HomeCubit.get(context).fix = "2";
                                                  ...
                                                  HomeCubit.get(context).fix = "4";
                                                }
                                                else if(val == "May"){
                                                  HomeCubit.get(context).fix = "5";

                                                }
                                                else if (val == "June"){
                                                  HomeCubit.get(context).fix = "6";
                                                }
                                                else if(val == "July"){
                                                  HomeCubit.get(context).fix = "7";

                                                }
                                                else if (val == "August"){
                                                  HomeCubit.get(context).fix = "8";
                                                }
                                                else if(val == "September"){
                                                  HomeCubit.get(context).fix = "9";

                                                }
                                                else if (val == "October"){
                                                  HomeCubit.get(context).fix = "10";
                                                }
                                                else if(val == "November"){
                                                  HomeCubit.get(context).fix = "11";

                                                }
                                                else if(val == "December"){
                                                  HomeCubit.get(context).fix = "12";

                                                }
                                                print(HomeCubit.get(context).fix);
                                                HomeCubit.get(context).chooseMonthFunction(val);
                                                HomeCubit.get(context).getSystemProfits();
                                          ...
                                          var items = [
                                            {
                                              ...
                                              "price": HomeCubit.get(context).systemProfit!.data!.accomodation.toString(),
                                            },
                                            {
                                              "image": "assets/images/home/product.png",
                                              "title": "Products",
                                              "route": "product",
                                              "price": HomeCubit.get(context).systemProfit!.data!.product.toString(),
                                            },
                                            {
                                              "image": "assets/images/home/activity.png",
                                              "title": "Activities",
                                              "route": "activities",
                                              "price": HomeCubit.get(context).systemProfit!.data!.activity.toString(),
                                            },
                                            {
                                              "image": "assets/images/home/trips.png",
                                              "title": "Trips",
                                              "route": "trips",
                                              "price": HomeCubit.get(context).systemProfit!.data!.trip.toString(),
                                            },
                                          ];
                                            ...
                                            child: Padding(
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: DropdownButton(
                                                    ...
                                                    borderRadius: BorderRadius.circular(10.r),
                                                    underline: SizedBox(),
                                                    value: HomeCubit.get(context).choseMonth,
                                                    hint: CustomText(text: "Blog  Type", size: 12.sp, color: darkGrey, fontWeight: FontWeight.w600),
                                            ...
                                            child: Padding(
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: DropdownButton(
                                                    ...
                                                    underline: SizedBox(),
                                                    value: HomeCubit.get(context).choseMonth,
                                                    hint: CustomText(text: "Status", size: 12.sp, color: darkGrey, fontWeight: FontWeight.w600),
                                                    items: [
                                                      "22-4-2024",
                                                      "24-6-2569",
                                                      "4-4-2024"
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              CustomText(text: "Blogs", size: 20.sp, color: black, fontWeight: FontWeight.w600),
                              SizedBox(width: 30.w,),
                          ...
                          SizedBox(height: 20.h),
                          Container(
                              child: HotelAccomandtion(controller: controller,))
