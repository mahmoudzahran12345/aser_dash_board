...
class HotelDateTableInsigthTrips extends StatelessWidget {
  final PageController triple;

  HotelDateTableInsigthTrips({super.key, required this.triple});
    ...
    return List.generate(
      12,
        ...
        cells: [
          ...
          DataCell(CustomText(text: "2 tickets", size: 14.sp, color: Color.fromRGBO(93, 102, 121, 1), fontWeight: FontWeight.w400)),
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        columns: [
          ...
          DataColumn(label: CustomText(text: "Number of tickets", size: 14.sp, color: const Color.fromRGBO(93, 102, 121, 1), fontWeight: FontWeight.w700)),
