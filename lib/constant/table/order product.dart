...
class OrderTableProduct extends StatelessWidget {
  final PageController product;

  OrderTableProduct({super.key, required this.product});
      ...
      12,
        ...
        onSelectChanged: (selected) {
          if (selected != null && selected) {
            product.animateToPage(5, duration: Duration(milliseconds: 300), curve: Curves.easeIn);
          }
        },
        cells: [
